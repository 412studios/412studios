...
const Carousel3Context = React.createContext<Carousel3ContextProps | null>(null);
...
const Carousel3Content = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => {
...
const Carousel3Item = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => {
...
const Carousel3Previous = React.forwardRef<HTMLButtonElement, React.ComponentProps<typeof Button>>(
...
const Carousel3Next = React.forwardRef<HTMLButtonElement, React.ComponentProps<typeof Button>>(
  ({ className, variant = "outline", size = "icon", ...props }, ref) => {
