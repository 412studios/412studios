...
>(({ className, children, ...props }, ref) => (
  <h2
    ref={ref}
    className={cn(
      "title title-mob hl font-bold text-6xl sm:text-6xl",
      className
    )}
    {...props}
  >
...
>(({ className, children, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn("hl title-mob font-bold text-md sm:text-xl", className)}
    {...props}
  >
    {children}
  </h3>
...
>(({ className, children, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("hl text-md sm:text-xl font-normal", className)}
    {...props}
  >
    {children}
  </p>
...
const Divider = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLDivElement>
>(({ className }, ref) => (
  <div ref={ref} className={cn("h-[1px] bg-foreground", className)} />
));
