  ...
  return (
    <>
      {isNavigating && !isExcluded() && (
        <div
          className="fixed top-0 left-0 w-full h-1 bg-muted transition-opacity duration-300 ease-out"
          style={{
            zIndex: 9998,
            opacity: navOpacity,
          }}
...
interface LoadingProviderProps {
  ...
  defaultExcludedPatterns?: string[]; // Changed to string[] for serialization
}
